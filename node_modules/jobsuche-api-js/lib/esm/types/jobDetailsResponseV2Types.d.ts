...
interface JobDetailsFertigkeitenInner {
    ...
    auspraegungen: {
        [key: string]: boolean | Date | string | object | number | Array<boolean | Date | string | object | number> | null;
    };
}
...
export { IJobDetailsV2ResponseProps, JobDetailsArbeitgeberAdresse, JobDetailsArbeitsorteInner, JobDetailsFertigkeitenInner, JobDetailsMobilitaet, JobDetailsFuehrungskompetenzen, };
